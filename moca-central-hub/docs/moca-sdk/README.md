...
```html
<script src="https://your-moca-central-hub.netlify.app/moca-sdk.js"></script>
```
...
const moca = new MocaSDK('https://your-moca-central-hub.netlify.app');
...
if (location.hostname === 'localhost') {
    moca.enableMockMode({
        client: { name: 'Local Client', logo_url: 'https://placehold.co/100/E52217/FFFFFF?text=L' },
